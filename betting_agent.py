...
class BettingAgent(object):
	def __init__(self, win_prob=WINNING_PROB,  num_win_chips = NUM_WIN_CHIPS):
		...
		self.num_win_chips = num_win_chips
		s,a,t,r, edge_probabilites, edge_action_labels = self._CreateParams()
		self.s = s
		self.a = a
		self.t = t 
		self.r = r
		self.edge_probabilites = edge_probabilites
		self.edge_action_labels = edge_action_labels
	...
	def _CreateParams(self):
		...
		return states, actions, trans, rewards, edge_probabilites, edge_action_labels
